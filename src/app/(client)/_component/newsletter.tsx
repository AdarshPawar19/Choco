            ...
            <div className="relative mx-auto flex max-w-4xl flex-col items-center justify-center rounded-3xl px-10 py-14 text-white">
                ...
                <div className="relative mt-6 w-[400px]">
                    <Input
                        ...
                        //TODO:Create table and merchant data in table(db)
                    />
                    <Button
                        variant="secondary"
                        className="absolute right-0 top-1/2 mr-1 h-8 -translate-y-1/2 transform bg-white text-brown-900 hover:bg-white text-black"
                        size="sm">
                        Subscribe
                    </Button>
                </div>
